...
class FillPermissionsForServerMeeting extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForServerMeeting constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.server-meeting',
            'admin.server-meeting.index',
            'admin.server-meeting.create',
            'admin.server-meeting.show',
            'admin.server-meeting.edit',
            'admin.server-meeting.delete',
            'admin.server-meeting.bulk-delete',
        ]);
